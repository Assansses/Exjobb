...
*
* Figure 76 shows how to calculate the value of the pull-up resistor used on the SCL and SDL
*
***********************************************************************************************/
#include <Wire.h>
...
void loop() {
  ...
  Wire.write(0xAA); //DATA 0
  Wire.write(0xAA); //DATA 1
  Wire.write(0xAA); //DATA 2
  Wire.write(0xAA); //DATA 3 
