...
uint8_t tx_buffer[6] = {0x00, 0x02, 0xBA, 0xDB, 0x01, 0xAA};
...
int main(void)
{
  ...
  //HAL_I2C_Master_Transmit(&hi2c1, NTP_ADDRESS, tx_buffer, 6, 1000); //HaL_MAX_DELAY

  //rx_address = {0x00, 0x02};
  //HAL_I2C_Master_Transmit(&hi2c1, NTP_ADDRESS, rx_address, 2, 1000);

  //HAL_I2C_Master_Receive(&hi2c1, NTP_ADDRESS, rx_buffer, 4, 1000);
